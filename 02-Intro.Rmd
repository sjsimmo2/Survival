...
The data sets we will be using are located on AWS.  They are not too large, so you can download them onto your local computer.  Here is an example of how to get the hurricane data set: 
